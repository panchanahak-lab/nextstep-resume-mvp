    ...
    <div>
      ...
      <Card className="p-6">
        <div className="flex flex-col sm:flex-row items-start gap-6">
          {/* Avatar */}
          <div className="w-20 h-20 rounded-full bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-2xl font-bold flex items-center justify-center flex-shrink-0">
            {mockUserProfile.name.split(' ').map((n) => n[0]).join('')}
          </div>

          {/* Info */}
          <div className="flex-1">
            <h2 className="text-xl font-bold text-neutral-900 dark:text-white">{mockUserProfile.name}</h2>
            <p className="text-primary-600 dark:text-primary-400 font-medium mt-1">{mockUserProfile.headline}</p>
            <p className="text-sm text-neutral-500 dark:text-neutral-400 flex items-center gap-1 mt-2">
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-3 leading-relaxed">{mockUserProfile.bio}</p>

            {/* Links */}
            <div className="flex gap-3 mt-4">
              {mockUserProfile.githubUrl && (
                <a
                  href={mockUserProfile.githubUrl}
                  target="_blank"
              ...
              {mockUserProfile.linkedinUrl && (
                <a
                  href={mockUserProfile.linkedinUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors"
                  aria-label="LinkedIn"
        ...
        <div className="mt-6 flex justify-end">
          <Button variant="primary">{COPY.PROFILE.ctaSave}</Button>
        </div>
      </Card>
