            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 relative">
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="p-4 bg-gray-50 rounded-xl">
                  <div className="h-8 w-8 bg-blue-100 text-blue-600 rounded-lg flex items-center justify-center font-bold mb-2">A</div>
                  <div className="text-sm font-semibold text-gray-900">ATS Ready</div>
                </div>
                <div className="p-4 bg-gray-50 rounded-xl">
                  <div className="h-8 w-8 bg-purple-100 text-purple-600 rounded-lg flex items-center justify-center font-bold mb-2">A+</div>
                  <div className="text-sm font-semibold text-gray-900">Interview Ready</div>
                </div>
              </div>
            </div>
          </div>
