      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 max-w-4xl mx-auto opacity-70">
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-sm font-semibold text-gray-600 dark:text-neutral-400">Private and secure</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Smartphone className="w-8 h-8 text-gray-400" />
            <span className="text-sm font-semibold text-gray-600 dark:text-neutral-400">Mobile-friendly</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <CreditCard className="w-8 h-8 text-gray-400" />
            <span className="text-sm font-semibold text-gray-600 dark:text-neutral-400">UPI-friendly</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Languages className="w-8 h-8 text-gray-400" />
            <span className="text-sm font-semibold text-gray-600 dark:text-neutral-400">Indian languages</span>
          </div>
        </div>
      </div>
    </section>
