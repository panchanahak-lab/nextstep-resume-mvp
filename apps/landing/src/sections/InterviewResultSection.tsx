    ...
    <section className="py-24 bg-white dark:bg-neutral-900 border-t border-gray-100 dark:border-neutral-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Your Interview Result</h2>
          <p className="text-gray-500 dark:text-neutral-500">Review your performance and try again to improve.</p>
        </div>
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-xl border border-gray-100 dark:border-neutral-800 overflow-hidden">
          <div className="p-8 text-center border-b border-gray-100 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-950">
            <div className="inline-flex flex-col items-center justify-center w-32 h-32 rounded-full border-8 border-green-400 bg-white dark:bg-neutral-900 shadow-inner mb-4">
              <span className="text-4xl font-extrabold text-gray-900 dark:text-white">72</span>
              <span className="text-sm font-bold text-gray-400">/100</span>
            </div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Good start! But you can do better.</h3>
          </div>
          ...
          <div className="p-8">
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border border-green-100 text-sm text-green-900">
              ...
              <div>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-4 border border-red-100 text-sm text-red-900">
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3 text-gray-700 dark:text-neutral-200 text-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100 dark:border-neutral-800">
              ...
              <button className="flex-1 flex items-center justify-center gap-2 bg-white dark:bg-neutral-900 text-gray-700 dark:text-neutral-200 border border-gray-200 dark:border-neutral-700 px-6 py-4 rounded-xl font-bold hover:bg-gray-50 dark:bg-neutral-950 transition-colors">
